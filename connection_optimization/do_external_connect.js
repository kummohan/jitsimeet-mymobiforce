 ...
 * in external_connect.js for My Mobiforce. Parses the room name and JSON Web
 * Token (JWT) from the URL and executes createConnectionExternally.
 *
 * NOTE: If you are using lib-jitsi-meet without My Mobiforce, you should use this
 * file as reference only because the implementation is My Mobiforce-specific.
 *
